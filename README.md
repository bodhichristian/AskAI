...
* <i>Submit button adapted from Polly Vern's Slider Button</i> (https://github.com/PollyVern/SwiftUI-Animations)
* <i>OpenAI API Client Library in Swift from https://github.com/adamrushy/OpenAISwift used for submitting requests and returning responses or errors.</i>
