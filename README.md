...
* <i>OpenAI API Client Library in Swift from Adam Rushy used for submitting requests and returning responses or errors.(https://github.com/adamrushy/OpenAISwift)</i>
